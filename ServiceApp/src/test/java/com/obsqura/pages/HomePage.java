...
public class HomePage {
	...
	public HomePage(WebDriver driver) {
	 ...
	 public void quickemailFieldWithoutMsg() throws IOException {
		 ...
		 Assert.assertEquals(expectedMsg,actualMsg,"alert message for missing msg not appeared");
		 }
	 ...
	 public void navigateToQualityAlertVerification() throws IOException {
		 ...
		 Assert.assertEquals(actualMsg, expectedMsg,"Not able to find a row in QualityAlert Page");
		 break;
		 }	 
	    }
	 ...
	 public void navigateToInventoryPageVerification() throws IOException {
		 ...
		 Assert.assertEquals(expectedPage, actualPage,"Navigation didn't occur to InventoryPage ");
	    }
	 ...
	 public void clientPageVerification() throws IOException {
		 ...
		 String actualPage = driver.getCurrentUrl();
		 Assert.assertEquals(expectedPage, actualPage,"Navigation didn't occur to clientPage");
	    }
	 ...
	 public void reparationPageVerification() throws IOException {
		 ...
		 String actualPage = driver.getCurrentUrl();
		 Assert.assertEquals(expectedPage, actualPage,"Navigation didn't occur to reparationPage");
	    }
     ...
     public void quickSMSFieldWithoutMsg() throws IOException {
    	 ...
    	 Assert.assertEquals(actualAlertMsg, expectedMsg,"alert message for missing msg not appeared");
     }
}
