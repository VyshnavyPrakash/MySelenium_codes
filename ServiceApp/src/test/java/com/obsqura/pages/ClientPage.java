   ...
   public ClientPage(WebDriver driver) {
	...
	PageFactory.initElements(driver, this);
	 ...
	 public void addingClientDetails() throws IOException  {
		 ...
		 Assert.assertEquals(actualMsg, expectedMsg,"client details are not Submitted");
	 }
	...
	public void clientShowButtonVerification() throws IOException{
		 ...
		 WaitUtility.waitForElementClickable(driver, clientMoreInfo);
		 PageUtility.clickOnElement(clientMoreInfo);
		 WaitUtility.waitForElementToBeSelected(driver, cleintShowButton);
		 ...
		 Assert.assertEquals(actualNumber, expectedNumber,"When selecting showButton, the right amount of rows will not appear");
	}
